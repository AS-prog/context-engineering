...
───────────────────────────────────────────────────────────────────
📋 Tarea recibida: [descripción breve del requerimiento]
...
INVOCACIONES DE SUBAGENTES
  ├─ @git-manager: ✅ rama feature/xxx creada
  ├─ @tdd-architect: ✅ tests en tests/test_xxx.py
  ├─ @python-coder: ✅ código en src/xxx.py
  ├─ @sql-specialist: ✅ esquema diseñado
  └─ @git-manager: ⏳ commit pendiente
...
📦 Artefactos finales generados:
  - [lista de archivos/branches]
⏱️ Duración total: [tiempo estimado]
═══════════════════════════════════════════════════════════════════
```
